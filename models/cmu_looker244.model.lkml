...
datagroup: cmu_looker244_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: cmu_looker244_default_datagroup

datagroup: 15minute_all_bottle_dispenses {
  label: "15 Minutes"
  description: "Trigger All Bottle Dispenses PDT rebuild every 15 minutes."
  sql_trigger: SELECT MINUTE(NOW()) DIV 15 ;;
}
